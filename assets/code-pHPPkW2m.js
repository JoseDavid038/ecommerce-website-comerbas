import{p as d}from"./main-Fofy9Hgr.js";const n=new Intl.NumberFormat("es-CO",{style:"currency",currency:"COP",minimumFractionDigits:0});function s(e,i){const c=document.querySelector(i);c&&(c.innerHTML=e.map(r=>`
