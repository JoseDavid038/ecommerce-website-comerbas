import{p as s}from"./main-8j3e4Ce3.js";const d=new Intl.NumberFormat("es-CO",{style:"currency",currency:"COP",minimumFractionDigits:0});function a(e,i){const c=document.querySelector(i);c&&(c.innerHTML=e.map(r=>`
