import{c as s,g as f,a as I,d as $,i as q,e as g,p as P}from"./main-sul6CIIo.js";const l=new Intl.NumberFormat("es-CO",{style:"currency",currency:"COP",minimumFractionDigits:0});function y(){if(!s||s.length===0){const e=`
      <p class="detalle__subtotal">Total productos: <span>${l.format(0)}</span></p>
      <p>Envío: <span>$0.00</span></p>
      <div class="subtotal-line">
        <p class="detalle__total">Total a financiar: <span>${l.format(0)}</span></p>
      </div>
    ...
    <p class="detalle__subtotal">Total productos: <span>${l.format(t)}</span></p>
    
    <div class="subtotal-line">
      <p class="detalle__total">Total a financiar: <span>${l.format(t)}</span></p>
    </div>
  `,o=document.querySelector(".js-payment-summary");o&&(o.innerHTML=a)}I();const T=new Intl.NumberFormat("es-CO",{style:"currency",currency:"COP",minimumFractionDigits:0});function B(){const t=document.querySelector("main");t&&(t.innerHTML=`
    ...
    `)}if(!s||s.length===0)B(),y();else{let t="";s.forEach(a=>{const o=a.productId;let e=f(o);e&&(t+=`
      <div class="detalle__producto js-cart-item-container-${e.id}">
        ...
        <div class="cart-item__details">
          ...
          <p class="detalle__precio">${T.format(e.price)}</p>
        </div>
